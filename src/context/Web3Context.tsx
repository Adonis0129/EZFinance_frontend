                ...
                if (userPositionInfo) {
                    ...
                    if (dex === 'pancake') {
                        ...
                        for (let i = 0; i < userPositionInfoData.positionInfo_pan.length; i++) {
                            ...
                            console.log('getUserPosition addr idx', i, idx1, userPositionInfoItem['positionInfo_pan'][`${i}`])

                            setUserPosition((userPosition) => (_.merge(
                                userPosition, {
                                ['pancake']: {
                                    [pair]: {
                                        [idx1]: userPositionInfoItem['positionInfo_pan'][i],
                                        ['length']: idx1 + 1,
                                    }
                                }
                            })))
                        ...
                        for (let i = 0; i < userPositionInfoData.positionInfo_liq.length; i++) {
                            ...
                            console.log('getUserPosition addr idx', i, idx2, userPositionInfoItem['positionInfo_liq'][`${i}`])

                            setUserPosition((userPosition) => (_.merge(
                                userPosition, {
                                ['liquid']: {
                                    [pair]: {
                                        [`${idx2}`]: userPositionInfoItem['positionInfo_liq'][`${i}`],
                                        ['length']: idx2 + 1,
                                    }
                                }
                            })))
                        ...
                        for (let i = 0; i < userPositionInfoData.positionInfo_aux.length; i++) {
                            ...
                            console.log('getUserPosition addr idx', i, idx3, userPositionInfoItem['positionInfo_aux'][`${i}`])

                            setUserPosition((userPosition) => (_.merge(
                                userPosition, {
                                ['aux']: {
                                    [pair]: {
                                        [`${idx3}`]: userPositionInfoItem['positionInfo_aux'][`${i}`],
                                        ['length']: idx3 + 1,
                                    }
                                }
                            })))
